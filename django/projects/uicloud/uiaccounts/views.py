...
def login(request):
    ...
    if user is not None:
        ...
        return render(request, 'uiaccounts/success.html', {'user':user,'username':username,'password':password})
    else:
        # Return an 'invalid login' error message.
        return render(request, 'uiaccounts/failed.html', {'user':user,'username':username,'password':password})
'''
